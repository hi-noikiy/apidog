...
class Swagger
{
    ...
    {
        if (!$this->config->get('apidog.enable', false)) {
            return 'swagger not start';
        }
        $domain = $this->config->get('apidog.swagger.host', '127.0.0.1');
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="//cdn.staticfile.org/swagger-ui/3.31.1/swagger-ui.min.css" >
    <link rel="icon" type="image/png" href="//mail.qq.com/zh_CN/htmledition/images/favicon/qqmail_favicon_48h.png" sizes="32x32" />
    <style>
      html
      {
...
';
    ...
    public function api()
    {
        ...
        $domain = $this->config->get('apidog.output_file', '');
